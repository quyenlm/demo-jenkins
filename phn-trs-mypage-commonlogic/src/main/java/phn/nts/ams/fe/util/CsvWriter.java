...
public class CsvWriter {
	...
	/**
	 * Creates a {@link pvn.metaweb.common.utility.csvreader.CsvWriter CsvWriter} object using a file
	...
	/**
	 * Creates a {@link pvn.metaweb.common.utility.csvreader.CsvWriter CsvWriter} object using a Writer
	 * to write data to.
	 * 
	 * @param outputStream
	...
	/**
	 * Creates a {@link pvn.metaweb.common.utility.csvreader.CsvWriter CsvWriter} object using an
	...
	/**
	 * @description show format as text in csv file
	 * @version NTS1.0
	 * @author Quan.Le.Minh
	 * @CrDate Dec 18, 2012
	 * @Copyright Posismo Hanoi Limited. All rights reserved.
	 */
	public static String getTextFormat(String value) {
